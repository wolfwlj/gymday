    ...
    <div class="pt-6">
        <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
            <div class="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
                <img :src="listing.listing.Images[0].ImageURL" alt="" class="h-full w-full object-cover object-center" />
            </div>
            <div class="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
                <div class="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg">
                    <img :src="listing.listing.Images[0].ImageURL" alt=""
        ...
        <div
            ...
            <!-- Options -->
            <div class="mt-4 lg:row-span-3 lg:mt-0 sticky overflow-hidden h-fit">
                ...
                <form class="mt-10">
                    <button type="submit"
                        class="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Training boeken</button>
                </form>
            </div>
                ...
                <div class="mx-auto mt-16 w-full max-w-2xl lg:col-span-4 lg:mt-0 lg:max-w-none">
                    <div class="flex border-t border-gray-200 pt-10 items-start space-x-4 mb-8">
                        <div class="flex-shrink-0">
                            <img class="inline-block h-10 w-10 rounded-full" :src="listing.listing.User.ProfilePicture"
                                alt="" />
                        </div>
